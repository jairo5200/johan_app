              ...
              <table className="w-full shadow-lg border border-gray-300 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-gray-700 text-white">
                    <th className="px-4 py-2 border-b border-gray-300">ID Usuario</th>
                  ...
                  {users.length > 0 ? (
                    users.map((user: any, index: number) => (
                      <tr key={index} className="text-center text-white bg-gray-800 border-b border-gray-300">
                        <td className="px-4 py-2 border-r border-gray-300">{user.id_usuario}</td>
                        ...
                        <td className="px-4 py-2 border-r border-gray-300">{user.rol}</td>
